...
describe "WebapiMapper" do
    context "Given JSON Response with list of Users" do
        it "It can create multiple users with empty order stream" do
            ...
            purchasesGroupedByUser = {}
            domainModels = WebapiUsersMapper.toDomainModel(givenUsersResponseJson, purchasesGroupedByUser)
        ...
        it "It can create multiple users with order stream populated" do
            ...
            purchasesGroupedByUser = {
                "KZHR-1H35-2IH8-JXYN" => OrderStreamBuilder.new.withAmountOfOrders(3).build
            }
